...
public class TerrainShader extends ShaderProgram {
	...
	private static final String VERTEX_FILE = ShaderProgram.SHADER_LOCATION + "terrain/TerrainVertexShader";
	private static final String FRAGMENT_FILE = ShaderProgram.SHADER_LOCATION + "terrain/TerrainFragmentShader";
