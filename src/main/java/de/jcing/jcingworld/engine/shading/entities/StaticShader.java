...
public class StaticShader extends ShaderProgram {
	...
	private static final String VERTEX_FILE = ShaderProgram.SHADER_LOCATION + "entities/vertexShader";
	private static final String FRAGMENT_FILE = ShaderProgram.SHADER_LOCATION + "entities/fragmentShader";
