...
public class Chunk {
	...
	public Chunk(float gridX, float gridZ, Loader loader, TerrainShader shader, TextureAtlas textureAtlas,
	...
	public boolean dismiss() {
		if (FileLoader.saveFile(tiles, new File("saves/" + Game.saveGameName + "/" + x + "x" + z + "/tiles.chk"))
				|| FileLoader.saveFile(tileTextureIndices,
						new File("saves/" + Game.saveGameName + "/" + x + "x" + z + "/mat.Jmt"))) {
			tiles = null;
	...
	private void fetchTiles() {
		tiles = (Tile[][]) FileLoader
				.loadFile(new File("saves/" + Game.saveGameName + "/" + x + "x" + z + "/tiles.chk"));
