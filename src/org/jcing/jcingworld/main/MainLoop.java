...
public class MainLoop {
	...
	private void loop() {
		...
		while (!glfwWindowShouldClose(window)) {
			manageMouse();
			game.tick();
			fpsText.setText("FPS: " + DisplayManager.fps + " X: " + dec.format(game.getPlayer().getPosition().x) + " Y: " + dec.format(game.getPlayer().getPosition().y)
			+ " Z: " + dec.format(game.getPlayer().getPosition().z));
