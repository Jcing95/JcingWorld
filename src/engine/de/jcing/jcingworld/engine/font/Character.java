package de.jcing.jcingworld.engine.font;
...
public class Character {
	 ...
	 *            this character.
	 */
	protected Character(int id, double xTextureCoord, double yTextureCoord, double xTexSize, double yTexSize, double xOffset, double yOffset,
