...
public class GraphicsLoader {
	...
	// essential for consistency later on!

	private List<Integer> vaos = new ArrayList<Integer>();
	private List<Integer> vbos = new ArrayList<Integer>();
	private List<Integer> textures = new ArrayList<Integer>();
	
	Log log = Log.getLog(GraphicsLoader.class);
	...
	public BaseImage loadTexture(String fileName, boolean linear) {
		...
		log.info("width: " + width + " height: " + height + " + ID: " + textureID);
		// image.flip();
		...
		log.info("succesfully loaded Texture [" + fileName + "]");
	...
	public BaseImage loadTexture(BufferedImage img, boolean linear) {
		log.info("-+-loading Texture from BufferedImage");
		...
		textures.add(textureID);
		log.info("succesfully loaded Texture from BufferedImage");
		return new BaseImage(width, height, textureID);
	}
