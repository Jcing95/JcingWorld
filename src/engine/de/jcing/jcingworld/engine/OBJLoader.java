...
public class OBJLoader {
	...
	private static Log log = Log.getLog(OBJLoader.class);

	public static RawModel loadObjModel(String fileName, GraphicsLoader loader) {
		FileReader fr = null;
		...
		log.info("succesfully loaded [" + fileName + "]");
